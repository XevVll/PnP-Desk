...
const ORTE = {
  ...
  // grabesinsel_scenes.js). Ankunft (grabesstrand) UND das Finale
  // (die_ritualkammer, Interaktionen ab "der_beginn_des_rituals") sind nach
  // Hendriks Vorgabe ausgearbeitet - reiner Inhalt/Text-Ablauf fuer die SL.
  // Eine interaktive Kampf-"Arena" (Positionen/Zonen fuer die Spieler waehrend
  // des Endkampfs) ist bewusst NICHT Teil dieser Interaktionen - die baut
  // Hendrik separat in einer anderen (technischen) Session.
  "grabesstrand": {
    personen: "James Harwick · Cormac Daly",
    ...
    interaktionen: {
      "die_letzte_frage": {
        ...
        details: "Das Beiboot liegt auf blankem schwarzem Fels statt auf Sand — ringsum fällt das Gestein steil ins Meer, dies ist die einzige Stelle, an der man überhaupt an Land kommt. Landeinwärts öffnet sich ein Tal zwischen zwei hohen, scharfkantigen Felswänden. Es ist alles gewachsener Stein, nichts daran ist gebaut. Pflanzen gibt es kaum, und die wenigen sind grau. Es ist still — keine Vögel, keine Brandung, wie man sie von den anderen Inseln kennt.\n\nWer den Blick hebt und dem Verlauf des Tals folgt, bemerkt vielleicht, wie regelmäßig sich die Bergrücken dahinter anordnen. Ausdrücklich NICHT von der SL erklären: wer selbst darauf kommt, dass die Anlage einem Kirchengrundriss ähnelt, soll das selbst aussprechen dürfen.\n\nBevor jemand losgeht, wird die Frage aus der Kajüte noch einmal gestellt — diesmal einzeln, mit der Insel vor Augen: Ist wirklich jeder sicher, dass er mitkommen will? Wer jetzt umkehrt, kehrt ohne Vorwurf um und wartet am Boot oder an Bord.\n\nSL-Hinweis: Die Frage ernst meinen und ernst stellen. Sie ist keine rhetorische Geste, um Spannung zu erzeugen — in Szene 12.1 hat Harwick zugesichert, dass niemand gezwungen wird, und das gilt hier weiterhin. Jedem Spieler einzeln die Gelegenheit geben zu antworten, statt die Gruppe als Block zu fragen.\n\nUnter den Männern, die mitkommen, ist auch Josiah. Niemand hätte ihn dabei erwartet — der Schiffskoch ist kein Kämpfer, und alle wissen das. Auf jeden Versuch, ihn zurückzuhalten, entgegnet er nichts. Er greift nur seine Waffe fester, mit einer Entschlossenheit, die man ihm bisher nie zugetraut hätte, und sagt kein Wort dazu, warum.\n\nSL-Hinweis zu Josiah: Seine Entscheidung steht fest, bevor die Frage überhaupt gestellt wird — keine Probe, kein noch so gutes Gegenargument bringt ihn zum Umkehren. Spieler dürfen es trotzdem versuchen, das ist echtes Rollenspiel und verdient Raum. Am Ergebnis ändert das nichts.\n\nDanach lässt Harwick mehrere Kisten von Bord holen und aufs schwarze Gestein tragen. Er erklärt nicht, was darin ist. Dann geht er los, den einzigen gangbaren Weg entlang, ohne sich umzudrehen und ohne zu prüfen, wer ihm folgt.",
        trigger: [
          { id: "landung_schwarzer_stein", label: "Landung auf blankem schwarzem Fels — die einzige mögliche Anlegestelle", info: "Ringsum fällt das Gestein steil ins Meer." },
          { id: "form_stimmt_nicht", label: "Alles gewachsener Fels — und trotzdem stimmt die Anordnung nicht", info: "Nichts daran ist gebaut. Wer selbst darauf kommt, dass die Bergrücken einem Kirchengrundriss folgen, soll das selbst aussprechen — nicht von der SL erklären." },
          ...
          { id: "josiah_besteht_darauf", label: "Josiah besteht darauf mitzukommen — obwohl er kein Kämpfer ist", info: "Auf jeden Versuch, ihn zurückzuhalten, greift er nur seine Waffe fester. Seine Entscheidung steht fest, bevor die Frage überhaupt gestellt wird — keine Probe bringt ihn zum Umkehren." },
  ...
  "die_ritualkammer": {
    ...
    kurz: "Das Ende des Wegs. Eine Halle von unmöglicher Größe — scharf behauene Rippen und Pfeiler, bei denen sich nicht entscheiden lässt, ob Menschenwerk oder Natur. Weit drinnen eine kaum kniehohe Anhöhe aus dem Fels, weich in den Kanten. Darauf liegt Jessica, als schliefe sie. Kein sichtbarer Schaden am Kind, obwohl sie seit Jahren tot ist.",
    interaktionen: {
      "das_kind_auf_dem_stein": {
        ...
        details: "VORLESE-TABLEAU — bewusst langsam, in dieser Reihenfolge:\n\nDer Gang öffnet sich, und dahinter ist ein Raum, der nicht auf diese Insel passt. Nicht groß wie eine Halle — groß wie eine Landschaft. Die Wände weichen nach beiden Seiten zurück, bis sie im Dunkeln nicht mehr auszumachen sind. Nach oben gibt es keine Decke, nur Fels, der in Rippen und Pfeilern aufsteigt und sich verliert, lange bevor das Licht ihn erreicht. Hinter der ersten Wand steht eine zweite, dahinter eine dritte, jede blasser als die davor. Wo das Ende ist, lässt sich nicht sagen — es hört nicht auf, es verschwindet.\n\nEs ist trocken und vollkommen still. Das grünlich-türkise Licht steht im Raum, ohne dass sich sagen ließe, woher es kommt.\n\nUnd es stimmt etwas nicht mit den Kanten. Der Fels ist stellenweise scharf und gerade geschlagen: hohe Rippen, Pfeilerformen, schmale Nischen, die oben spitz zulaufen. Daneben bricht dasselbe Gestein roh und ungeordnet weg. Es gibt kein Ornament, keine Zeichen, keine Fuge, keine einzige Werkzeugspur — und trotzdem ist die Anordnung zu absichtlich, um Zufall zu sein. Wer entscheiden will, ob das hier gebaut wurde oder gewachsen ist, kann es nicht.\n\nWeit drinnen, klein in all dem Raum, erhebt sich eine flache Anhöhe aus dem Boden, kaum kniehoch, mit weichen, runden Kanten — als einziges in dieser Halle nicht scharf, sondern sanft.\n\nDarauf liegt ein Mädchen. Sie liegt auf dem Rücken, die Hände nicht gefaltet, sondern einfach abgelegt, den Kopf ein wenig zur Seite. Sie sieht aus, als schliefe sie.\n\nAn ihr ist nichts kaputt. Keine Wunde, kein Blut, keine Spur von dem, was ihr zugestoßen ist. Nichts an ihr sieht so aus, als läge sie seit Jahren hier.\n\nSL-HINWEISE:\n— Hier nichts erklären. Keine Probe verlangen, keine Wahrnehmung, keine Wissensprobe. Es gibt nichts zu entdecken, was nicht ohnehin jeder sieht, und jede Mechanik an dieser Stelle würde den Moment zerreden.\n— Nach dem Tableau eine echte Pause lassen. Die Spieler sollen als Erste sprechen dürfen, nicht die SL.\n— Harwick: Wie er reagiert, hängt vom Ausgang der Kinder-Rettung im Artefakthandel ab (siehe ORTE.kapitaenskajuete, \"Harwick nach dem Verrat\", und Bibel 12.1). In der gespielten Runde wurden die Kinder gerettet — er ist also nicht dauerhaft manisch, was diesen Moment eher still als fiebrig macht.\n— Cormac, falls er mitgekommen ist: Er trägt die Schuld an ihrem Tod (Bibel 8.1). Das geknotete Seil, das sie ihm beibrachte, darf laut Bibel 2.7 höchstens noch ein einziges Mal auftauchen — falls es in der Einberufung (12.1) schon dran war, hier nicht mehr.\n\nWas danach geschieht — das Ritual selbst, sein Scheitern, die Untoten und der Endkampf (Bibel 12.1) — siehe die folgenden Interaktionen dieses Orts, beginnend mit \"Cormacs Abschied und der Beginn des Rituals\".",
        trigger: [
          { id: "halle_oeffnet_sich", label: "Ein Raum, der nicht auf diese Insel passt — groß wie eine Landschaft", info: "Keine Decke, nur Fels, der sich verliert. Hinter der ersten Wand eine zweite, dahinter eine dritte. Es hört nicht auf, es verschwindet." },
          { id: "licht_ohne_quelle", label: "Das grünlich-türkise Licht steht im Raum, ohne erkennbare Quelle", info: "Es lässt sich nicht sagen, woher es kommt. Trocken, vollkommen still." },
          { id: "kanten_mensch_oder_natur", label: "Scharf geschlagene Rippen und Pfeiler — daneben roher Bruch", info: "Kein Ornament, keine Zeichen, keine Fuge, keine Werkzeugspur — und trotzdem zu absichtlich für Zufall. Ob gebaut oder gewachsen, lässt sich nicht entscheiden." },
          { id: "die_anhoehe", label: "Weit drinnen eine kaum kniehohe Anhöhe, als einziges sanft statt scharf", info: "Weiche, runde Kanten, klein in all dem Raum." },
      ...
      // Das Finale (Bibel 12.1). Sechs Interaktionen, die den kompletten
      // Ablauf des Endkampfs als Text-Beats fuer die SL abbilden - inhaltlich
      // in einer Sparring-Session mit Hendrik entwickelt (siehe Plan-Dokument
      // "in-einer-anderen-session-idempotent-lynx.md"). KEINE interaktive
      // Kampf-Arena (Positionen/Zonen) - die baut Hendrik separat in einer
      // anderen, technischen Session. Reihenfolge ist als grobe Chronologie
      // gedacht (Vorspiel -> erste Wellen -> Wat/Josiah fallen -> Zermuerbung
      // -> Harwicks Anklage -> Entscheidung um den Saebel), Phase 3
      // ("die_zermuerbung") ist bewusst modular/ungeordnet gehalten.
      "der_beginn_des_rituals": {
        title: "Cormacs Abschied und der Beginn des Rituals",
        kurz: "Cormac drückt Jessica vor dem Ritual ein kleines Holzschwert in die Hand. Harwick beginnt das Ritual mit dem erhandelten Artefakt (Szene 9.1) — kurzer hoffnungsvoller Moment, der kippt: ein Riss läuft durch Boden und Wände, die ersten Toten lösen sich aus den Rippen und Nischen der Halle.",
        details: "Bevor Harwick beginnt, tritt Cormac kurz an die Anhöhe. Er sagt nicht viel — drückt Jessica nur ein kleines, abgegriffenes Holzschwert in die Hand, ein Spielzeug, kein echtes Wort dazu, was es bedeutet.\n\n„Was auch immer gleich passiert. Hiermit kämpfst du dich zurück, wie es schon immer war.“\n\nNiemand kommentiert es.\n\nDann holt Harwick das erhandelte Artefakt hervor (der Ritual-Schlüssel aus dem Handel, Szene 9.1) und beginnt das Ritual. Zuerst wird es heller, wärmer — das grünlich-türkise Licht schlägt für einen Herzschlag lang fast golden um, und für einen Moment sieht es aus, als würde es gelingen.\n\nDann kippt es zurück. Das Licht schlägt hart ins Grünliche zurück, tiefer und kälter als zuvor. Irgendwo im Fels, zu tief, um es zu orten, läuft ein Riss — ein Geräusch wie brechendes Eis, nur viel größer. Aus den Rippen und Nischen der Halle, aus jedem Schatten zwischen den Pfeilern, lösen sich Gestalten.\n\nSL-Hinweis: Diesen Moment mit Cormac nicht erklären oder ausdeuten — er steht einfach da, ein kleines, stilles Bild, bevor der Lärm beginnt. Hier beginnt der eigentliche Endkampf; wie er räumlich abläuft (Positionen, Bewegungsfreiheit), ist bewusst nicht Teil dieses Textes — das liefert eine separate technische Ausarbeitung.",
        trigger: [
          { id: "cormac_holzschwert", label: "Cormac drückt Jessica vor dem Ritual ein Holzschwert in die Hand", info: "„Was auch immer gleich passiert. Hiermit kämpfst du dich zurück, wie es schon immer war.“ Nicht kommentieren oder ausdeuten." },
          { id: "ritual_beginnt", label: "Harwick beginnt das Ritual mit dem erhandelten Artefakt (Szene 9.1)", info: "Für einen Herzschlag lang schlägt das Licht fast golden um — es sieht aus, als würde es gelingen." },
          { id: "ritual_kippt", label: "Das Ritual kippt — das Licht schlägt hart ins Grünliche zurück", info: "Tiefer und kälter als zuvor. Ein Riss läuft durch den Fels, ein Geräusch wie brechendes Eis, nur viel größer." },
          { id: "erste_tote_erscheinen", label: "Aus den Rippen und Nischen der Halle lösen sich die ersten Gestalten", info: "Aus jedem Schatten zwischen den Pfeilern." }
        ]
      },

      "die_ersten_wellen": {
        title: "Die ersten Wellen",
        kurz: "Der Kampf beginnt. Wer den Jaguar-Säbel führt, entdeckt seine Eigenschaft: eine Berührung lässt die getroffene Seele zurückweichen — aber Ersatz kommt nach, ohne dass die Gesamtzahl sichtbar sinkt.",
        details: "Die ersten Toten sind nicht alle aus derselben Zeit. Wer genau hinsieht: Reste eines Dreispitzes, Fragmente einer Rüstung, die niemand an Bord kennt, ein Gewand, das zu keiner bekannten Nation passt. Nichts, was die SL erklärt — nur etwas, das im Hintergrund mitläuft, falls jemand danach fragt: Diese Insel sammelt seit sehr langer Zeit Schiffbrüchige, und keiner von ihnen ist je wieder weggekommen.\n\nWer den Jaguar-Säbel führt, merkt schnell: Eine Berührung lässt die getroffene Seele als fahles Licht zurückweichen — ein Gegner weniger. Aber es kommt kein Gefühl von Fortschritt auf. Für jeden, der zurückweicht, kommt ein anderer nach, aus einem Riss, einer Nische, einem Schatten, der eben noch leer war.\n\nSL-Hinweis: Wichtig für die Stimmung dieser ganzen Phase — es darf sich nie wie ein gewinnbarer Kampf anfühlen, nur wie eines, das man eine Weile aushält.",
        trigger: [
          { id: "tote_verschiedener_epochen", label: "Die Toten sind nicht alle aus derselben Zeit", info: "Reste eines Dreispitzes, unbekannte Rüstungsfragmente, ein Gewand ohne erkennbare Herkunft — diese Insel sammelt seit sehr langer Zeit Schiffbrüchige." },
          { id: "saebel_schickt_seelen_zurueck", label: "Der Jaguar-Säbel: eine Berührung lässt die Seele zurückweichen", info: "Ein Gegner weniger — aber kein Gefühl von Fortschritt. Für jeden, der zurückweicht, kommt ein anderer nach." }
        ]
      },

      "wat_und_josiah_fallen": {
        title: "Wat und Josiah fallen",
        kurz: "Wat wirft sich vor einen bedrängten Spieler in die Menge der Toten und stirbt. Der Seelenlose spricht zum ersten Mal. Josiah stürzt sich verzweifelt auf die Toten, die auf Wat einhacken, und fällt ebenfalls.",
        details: "Einer der Spieler gerät in echte Bedrängnis — umzingelt oder zu Boden gebracht. Wat wirft sich dazwischen, direkt in die Menge der Toten.\n\nEr fällt.\n\nIn diesem Moment spricht zum ersten Mal eine Stimme, die durch die ganze Halle trägt — ruhig, nicht triumphierend, fast wie eine Feststellung:\n\n„Kein Toter verlässt je diese Insel.“\n\nDas ist Der Seelenlose — Herr der endlosen Toten dieses Ortes. Er muss sich nicht zeigen, um gehört zu werden.\n\nJosiah, der sich bis dahin eher zurückgehalten hat, stürzt sich verzweifelt auf die Toten, die auf den bereits gefallenen Wat einhacken. Auch er fällt.\n\nSL-Hinweis: Hier eine echte Pause lassen, bevor der Kampf weitergeht. Kein sofortiger Anschlusskampf-Kommentar, keine Regieanweisung, die den Moment überspielt — die Spieler sollen als Erste reagieren dürfen.\n\nSL-Hinweis zu Der Seelenlose: Kein Monster, keine große Erscheinung nötig — eine schlanke, reglose Gestalt zwischen den Pfeilern, die sich nie sichtbar bewegt, aber plötzlich näher oder weiter weg steht, als sie eben noch war.",
        trigger: [
          { id: "wat_opfert_sich", label: "Wat wirft sich vor einen bedrängten Spieler in die Menge der Toten", info: "Er fällt." },
          { id: "seelenlose_erste_worte", label: "Der Seelenlose spricht zum ersten Mal, ruhig, nicht triumphierend", info: "„Kein Toter verlässt je diese Insel.“" },
          { id: "josiah_opfert_sich", label: "Josiah stürzt sich auf die Toten, die auf Wat einhacken", info: "Auch er fällt." },
          { id: "pause_nach_den_toden", label: "SL: echte Pause lassen, die Spieler reagieren zuerst", info: "Kein sofortiger Anschlusskampf-Kommentar." }
        ]
      },

      "die_zermuerbung": {
        title: "Die Zermürbung",
        kurz: "Der Kampf zieht sich, ohne Ende in Sicht. Modulare Ereignisse zum Einstreuen: weitere Tote aus neuen Rissen, ein erneut bedrängter Spieler, Cormacs stiller Schuld-Moment, der Introll-Hinweis zum Jaguar als Wandler zwischen den Welten.",
        details: "Der Kampf zieht sich, ohne dass ein Ende absehbar ist. Die folgenden Ereignisse lassen sich nach Gefühl einstreuen, statt in fester Reihenfolge:\n\n— Ein Spieler gerät erneut in echte Gefahr (umzingelt, zu Boden). Zeigt: reines Durchkämpfen laugt aus, es rettet nicht.\n— Aus vorher leeren Rissen im Fels lösen sich weitere Tote — die Halle hat noch lange nicht alles hergegeben, was sie über die Jahrhunderte gesammelt hat.\n— Cormac stockt kurz in der Nähe der Anhöhe, der Blick auf Jessica. Kein Kommentar nötig, keine Mechanik dazu — nur ein kurzer, stiller Moment seiner Schuld (Bibel 8.1).\n— Der Introll-Hinweis: Der Spieler, der in der Riffinsel-Grotte (Szene 11.1) das Symbolrätsel gelöst hat, darf hier 1-2 Intelligenz-Proben ablegen. Bei Erfolg erinnert er sich an etwas, das beim Auflösen des Reims („Herrscher der Welt unter bei Nacht“) fast beiläufig mitschwang: Manche Naturvölker verehren den Jaguar nicht nur als Jäger der Nacht, sondern als Wandler zwischen den Welten — einen Wächter, der zwischen Leben und Tod wechseln kann, ohne selbst unterzugehen.\n\nSL-Hinweis: Der Introll-Hinweis ist kein Befehl und keine Lösung, nur ein Steinchen. Die Gruppe muss selbst auf die Idee kommen, was sie damit macht — nicht vorsagen, was als Nächstes zu tun ist.",
        trigger: [
          { id: "spieler_erneut_bedraengt", label: "Ein Spieler gerät erneut in echte Gefahr", info: "Zeigt: reines Durchkämpfen laugt aus, es rettet nicht." },
          { id: "weitere_risse_oeffnen_sich", label: "Aus vorher leeren Rissen lösen sich weitere Tote", info: "Die Halle hat noch lange nicht alles hergegeben, was sie über die Jahrhunderte gesammelt hat." },
          { id: "cormac_stockt", label: "Cormac stockt kurz nahe der Anhöhe, Blick auf Jessica", info: "Kein Kommentar, keine Mechanik — ein stiller Moment seiner Schuld." },
          { id: "introll_wandler_zwischen_welten", label: "Introll-Hinweis (1-2 Proben) für den Löser des Grotten-Rätsels", info: "Manche Naturvölker verehren den Jaguar als Wandler zwischen den Welten — einen Wächter, der zwischen Leben und Tod wechseln kann, ohne selbst unterzugehen." }
        ]
      },

      "harwicks_anklage": {
        title: "Harwicks Rückzugsbefehl und die Anklage",
        kurz: "Harwick erkennt die Ausweglosigkeit, befiehlt den Rückzug und bleibt selbst zurück. Der Seelenlose hält ihm seine wahre Schuld vor — nicht Liebe halte Jessica hier, sondern sein Egoismus.",
        details: "Harwick erkennt: Das hier ist nicht zu gewinnen. Er befiehlt Crew und Spielern den Rückzug — bleibt selbst zurück.\n\nDer Seelenlose lacht ihn aus. Keine Bosheit dabei, eher etwas wie Bedauern:\n\n„Du kämpfst gegen den Tod selbst — welche Torheit. Nicht Liebe hält sie hier, sondern dein Egoismus. Du hast deine Last nie getragen. Du hast sie ihr aufgebürdet, seit dem Tag, an dem sie starb.“\n\nSL-Hinweis: Dies ist der eigentliche Wendepunkt der ganzen Szene — nicht der Kampf entscheidet das Ende, sondern was jetzt mit dem Jaguar-Säbel geschieht (siehe „Die Entscheidung um den Säbel“).",
        trigger: [
          { id: "harwick_befiehlt_rueckzug", label: "Harwick befiehlt den Rückzug — und bleibt selbst zurück", info: "Er erkennt: Das hier ist nicht zu gewinnen." },
          { id: "seelenlose_anklage", label: "Der Seelenlose klagt Harwick an, nicht triumphierend, fast bedauernd", info: "„Du kämpfst gegen den Tod selbst — welche Torheit. Nicht Liebe hält sie hier, sondern dein Egoismus. Du hast deine Last nie getragen. Du hast sie ihr aufgebürdet, seit dem Tag, an dem sie starb.“" }
        ]
      },

      "die_entscheidung_um_den_saebel": {
        title: "Die Entscheidung um den Säbel",
        kurz: "Drei Ausgänge, abhängig davon, wem der Jaguar-Säbel in die Hand gedrückt wird: Jessica (bestes Ende, Harwick überlebt und begräbt die Toten), Harwick (er opfert sich, Jessicas Schicksal bleibt unausgesprochen), oder niemand (härtestes Ende, Harwick stirbt unter Spott).",
        details: "Ab hier entscheidet nicht mehr der Kampf, sondern wem der Jaguar-Säbel übergeben wird.\n\nSÄBEL AN JESSICA (bestes Ende): Sie richtet sich auf und kämpft sich mit dem Säbel selbst frei — vielleicht liegt neben ihrer Hand noch immer das kleine Holzschwert, das Cormac ihr gab. Sie ruht. Harwick überlebt, weint, hält ihren Kopf in beiden Händen, küsst ihre Stirn. Er schickt die Gruppe fort, holt selbst einen Spaten und gräbt Wat, Josiah und den übrigen Gefallenen Gräber. Er bittet, allein gelassen zu werden — er habe diese Männer in den Tod geschickt, er werde sie auch begraben.\n\nSL-Hinweis: Wer wartet, statt zu gehen — die Szene endet, bevor er zurückkehrt. Kein erzwungener Cutscene-Moment, nur ein weicher Hinweis, dass es Zeit ist zu gehen.\n\nSÄBEL AN HARWICK (Mittelweg): Er dominiert für eine Weile die Toten, aber ihre Zahl schwindet nicht. Er erkennt die Ausweglosigkeit und opfert sich selbst. Was mit Jessica geschieht, bleibt bewusst unausgesprochen — seine Trauer, die sie im Zwischen hielt, besteht mit seinem Tod nicht mehr fort, aber das sagt niemand laut. Reiner Interpretationsspielraum für den Tisch.\n\nSÄBEL BEI NIEMANDEM (härtestes Ende): Die Toten greifen nach den Fliehenden. Harwick stürmt selbst in die Menge, kauft Zeit — und wird unter dem Gelächter Der Seelenlosen von ihm und seinen Dienern mehrfach durchbohrt. Sein letzter Ruf an die Crew:\n\n„Es tut mir leid — kommt nie wieder hierher zurück.“\n\nSL-Hinweis: Alle drei Enden sind gleichwertig als Schluss gedacht, keines ist eine Bestrafung für falsches Spiel — sie unterscheiden sich nur darin, wie teuer der Preis am Ende ist.",
        trigger: [
          { id: "saebel_an_jessica", label: "Säbel an Jessica: sie kämpft sich frei, Harwick überlebt und begräbt die Toten", info: "Er küsst ihre Stirn, schickt die Gruppe fort, gräbt selbst die Gräber. Wer wartet statt zu gehen: die Szene endet, bevor er zurückkehrt." },
          { id: "saebel_an_harwick", label: "Säbel an Harwick: er dominiert kurz, opfert sich dann selbst", info: "Jessicas Schicksal bleibt unausgesprochen — reiner Interpretationsspielraum." },
          { id: "saebel_bei_niemandem", label: "Säbel bei niemandem: Harwick stirbt unter dem Spott Der Seelenlosen", info: "„Es tut mir leid — kommt nie wieder hierher zurück.“" }
        ]
      }
    }
  },
  ...
  "versteckte_grotte": {
    ...
    interaktionen: {
      "der_fund_in_der_grotte": {
        ...
        kurz: "Kein Naturhohlraum, sondern ein urzeitliches Steinbauwerk: bearbeitete Wände, eine in den Fels gehauene Zeichentafel, vier Siegelsteine und eine steinerne Klappe, die verschlossen ist. Kein Metall, kein Holz, nichts Europäisches — siehe Interaktion \"Das Rätsel der Grotte\" für die Auflösung.",
        details: "Wer den Spalt im Fels findet und sich hindurchzwängt, merkt nach wenigen Schritten, dass das hier kein normaler Hohlraum ist. Die Wände sind zu gerade. Der Boden ist zu eben. Was von außen wie ein zufälliger Riss im Fels aussah, ist innen bearbeiteter Stein — jemand hat diese Grotte aus dem Berg geschlagen, und das vor sehr langer Zeit.\n\nAlles hier ist aus einem Stück: Wände, Boden, Decke, dieselbe dunkle Gesteinsart, an den Kanten von Alter und Feuchtigkeit rund geschliffen. Kein Holz, kein Metall, kein Mörtel — nichts, was nach einem europäischen Schiff oder einem europäischen Handwerker aussieht. Die Machart wirkt älter als alles, was irgendwer an Bord der Golden Lion einordnen könnte: schwer, klobig, ohne Verzierung um der Verzierung willen, aber mit einer Präzision, die man dem groben Eindruck erst auf den zweiten Blick ansieht. Kühl, staubtrocken, vollkommen still; das Licht von draußen reicht nur wenige Schritte hinein, dahinter braucht es Fackel oder Laterne.\n\nAn der Rückwand drei Dinge, alle Teil des Bauwerks selbst:\n— Eine große Tafel, direkt aus der Wand gehauen, über und über mit eingeschlagenen Zeichen bedeckt, in Reihen angeordnet.\n— Darunter, in Griffhöhe, vier steinerne Siegelscheiben, lose in flachen Mulden liegend — die einzigen beweglichen Teile im ganzen Raum. Jede trägt ein anderes Tier als Relief.\n— Daneben eine rechteckige steinerne Klappe, fugengenau in die Wand eingelassen, mit einer leeren runden Vertiefung in der Mitte. Sie lässt sich nicht aufhebeln, nicht verschieben und nicht eindrücken; Gewalt bringt hier gar nichts, das ist massiver Fels.\n\nWas hinter der Klappe liegt, ist von außen nicht zu sehen und nicht zu erahnen. Bewusst kein Aha-Moment an dieser Stelle: Die Gruppe steht vor etwas offensichtlich sehr Altem, das älter ist als jede Seefahrergeschichte, die sie kennen — und bekommt keine Erklärung dazu, weder jetzt noch beim Öffnen.",
        trigger: [
          { id: "grotte_betreten", label: "Der Spalt im Fels wird gefunden, die Grotte betreten", info: "Kühl, staubtrocken, vollkommen still. Das Licht von draußen reicht nur wenige Schritte hinein." },
          { id: "kein_naturhohlraum", label: "Es ist kein Naturhohlraum — die Wände sind zu gerade, der Boden zu eben", info: "Bearbeiteter Stein. Jemand hat diese Grotte aus dem Berg geschlagen, vor sehr langer Zeit." },
          { id: "urzeitliche_machart", label: "Alles aus einem Stück Stein — kein Holz, kein Metall, kein Mörtel", info: "Schwer, klobig, ohne Verzierung um der Verzierung willen, aber präziser, als der grobe Eindruck vermuten lässt. Nichts Europäisches." },
          { id: "tafel_entdeckt", label: "Eine Zeichentafel, direkt aus der Wand gehauen", info: "Über und über mit eingeschlagenen Zeichen bedeckt, in Reihen angeordnet." },
          { id: "siegelsteine_entdeckt", label: "Vier steinerne Siegelscheiben in flachen Mulden, je ein Tier-Relief", info: "Die einzigen beweglichen Teile im ganzen Raum." },
          { id: "klappe_entdeckt", label: "Eine steinerne Klappe mit leerer runder Vertiefung — Gewalt bringt nichts", info: "Fugengenau in die Wand eingelassen, nicht aufhebelbar, nicht verschiebbar. Massiver Fels." }
        ]
      },
      "das_raetsel_der_grotte": {
        title: "Das Rätsel der Grotte",
        kurz: "Eine Intelligenz-Probe an der Zeichentafel gibt dem Spieler den Reim (wörtlich vorlesen/aushändigen). Lösung ist der Jaguar — von vier Siegelsteinen (Eule/Katze/Schlange/Maus) ist die KATZE der richtige. In die Vertiefung gedrückt, fährt die steinerne Klappe auf; dahinter ein verzierter Säbel mit eingraviertem Jaguar. Falscher Stein: Knall und ein Fauchen wie von einer Großkatze, beliebig oft erneut versuchbar — SL-Ermessen: wiederholter Lärm kann die Affen früher auf die Gruppe aufmerksam machen.",
        details: "Reim und Symbole stammen von Hendrik, wörtlich übernommen. Die Zeichen auf der Tafel ergeben auf den ersten Blick keinen Sinn — erst eine erfolgreiche Intelligenz-Probe setzt genug davon zusammen. Wer sie schafft, bekommt DIESEN Text (am besten wörtlich vorlesen oder ausgedruckt aushändigen):\n\n„In Ringen aus Nacht, die Sonne wohnt,\nein anderer als ich, das Wasser meidet.\nKnack ich den Schädel ungeschont,\nkein Laut der durch die Stille schneidet.\nAlleine wachend zum Licht gebracht,\nHerrscher der Welt unter bei Nacht.“\n\nDie Symbole auf der Tafel, Zeile für Zeile (so beschreiben, falls jemand die Tafel selbst lesen statt den Reim hören will):\n— Ring · Nacht · Sonne\n— Familie · Wasser · X\n— Kaputter Schädel\n— Wellen · Geräusche · X\n— Sonne · Figur (Wächter)\n— Nacht (Linie darüber, Sterne) · eine Figur (Herrscher)\n\nIn den Mulden darunter liegen vier steinerne Siegelscheiben mit Tier-Reliefs: Eule, Katze, Schlange, Maus. Jede passt von der Größe her genau in die leere runde Vertiefung in der steinernen Klappe.\n\nLÖSUNG: die KATZE. Der Reim beschreibt den Jaguar, und die Katze ist von den vieren das einzige Symbol, das ihn abbildet. Auflösung Zeile für Zeile, falls die Gruppe hängt und du nachhelfen willst: „Ringe aus Nacht, in denen die Sonne wohnt“ sind die Rosetten auf goldenem Fell. „Ein anderer als ich meidet das Wasser“ — anders als der Rest seiner Familie scheut der Jaguar das Wasser nicht, er schwimmt. Der Schädelbiss ist seine Art zu töten. Lautlos, einzelgängerisch, und Herrscher der Unterwelt bei Nacht.\n\nBEI RICHTIGER WAHL: Der Stein sitzt satt in der Vertiefung, es rumpelt tief im Fels, und die steinerne Klappe fährt auf — schwer, langsam, mit einem Mahlen, das man im Boden spürt. Dahinter eine flache Nische, ebenfalls aus dem Fels geschlagen, und darin ein verzierter Säbel, in dessen Klinge ein Jaguar eingraviert ist. Wie ein Säbel in ein Bauwerk kommt, das älter aussieht als jede Klinge dieser Bauart, wird an dieser Stelle nicht erklärt — die Gruppe bekommt den Fund, keine Erklärung dazu (Bibel 7.4: \"ein Vorteil, den die Spieler haben, ohne ihn zu kennen\").\n\nBEI FALSCHEM STEIN: Ein Knall ertönt und ein Fauchen, wie von einer Großkatze — irgendwo aus dem Stein selbst, nicht aus einer Richtung, die sich benennen ließe. Die Klappe bleibt zu, nichts geht kaputt, der Stein lässt sich wieder herausnehmen, ein erneuter Versuch mit einem anderen ist jederzeit möglich.\n\nGewalt ist ausdrücklich kein Weg: Die Klappe ist massiver Fels, kein Scharnier, kein Schloss, nichts zum Aufbrechen. Wer es mit Brechstange oder Axt versucht, richtet nur Lärm an.\n\nSL-Ermessen: Der Lärm bleibt nicht zwangsläufig folgenlos — wiederholte laute Fehlversuche (und Aufbrechversuche erst recht) können das Risiko erhöhen, dass die Affen früher als sonst auf die Gruppe aufmerksam werden (siehe ORTE.riffstrand, Interaktion \"Die Affen greifen an\").",
        trigger: [
          ...
          { id: "vier_steine_vorhanden", label: "Vier Siegelsteine mit Tier-Reliefs: Eule, Katze, Schlange, Maus", info: "Jede Scheibe passt von der Größe her genau in die runde Vertiefung in der steinernen Klappe." },
          ...
          { id: "klappe_faehrt_auf", label: "Die steinerne Klappe fährt auf — schweres Mahlen, im Boden spürbar", info: "Dahinter eine flache, aus dem Fels geschlagene Nische." },
          { id: "belohnung_saebel", label: "In der Nische: verzierter Säbel mit eingraviertem Jaguar", info: "Schlicht eine sehr gute Waffe, keine Sonderregel — vereinfacht später den Endkampf (Bibel 12.1). Am Tisch unerklärt: wie er in ein so viel älteres Bauwerk kommt, wird nie aufgelöst." },
          { id: "falscher_stein_knall", label: "Falscher Stein → Knall und Fauchen aus dem Stein selbst, erneut versuchbar", info: "Die Klappe bleibt zu, nichts geht kaputt, der Stein lässt sich wieder herausnehmen." },
          { id: "gewalt_bringt_nichts", label: "Gewalt ist kein Weg — massiver Fels, kein Scharnier, kein Schloss", info: "Wer es mit Brechstange oder Axt versucht, richtet nur Lärm an." },
          { id: "sl_ermessen_laerm_affen", label: "SL-Ermessen: wiederholter Lärm kann die Affen früher aufmerksam machen", info: "Wiederholte laute Fehlversuche (und Aufbrechversuche erst recht) können das Risiko erhöhen, dass die Affen früher als sonst angreifen (siehe ORTE.riffstrand, \"Die Affen greifen an\")." }
        ]
      }
    }
  }
