...
const ORTE = {
  ...
  "riffstrand": {
    ...
    interaktionen: {
      ...
      "die_eingeborenen": {
        ...
        kurz: "SL-Ermessen: Nach 30-60 Minuten realer Erkundungszeit (Stoppuhr im Adminpanel) ist die Insel doch nicht so verlassen, wie sie wirkte — feindliche Ureinwohner greifen an und jagen die Gruppe zurück zum Schiff. Beendet die Erkundung bewusst vorzeitig, bevor alles gefunden werden kann. Wiederholte laute Fehlversuche am Rätsel der Kiste (versteckte Grotte) können den Zeitpunkt vorziehen.",
        details: "Die Insel wirkt nur auf den ersten Blick menschenleer. Nach SL-Ermessen — als grober Richtwert 30 bis 60 Minuten reale Erkundungszeit, mit der Stoppuhr im Adminpanel mitgezählt — wird klar, dass die Gruppe hier nicht allein ist: Aus dem Dickicht tauchen feindliche Ureinwohner auf, bewaffnet und entschlossen, die Eindringlinge zu vertreiben.\n\nEs folgt keine Verhandlung, sondern eine Verfolgungsjagd: Die Gruppe wird zurück in Richtung Strand und Boot gedrängt, ohne Zeit, sich noch großartig zu wehren oder das Vorhaben fortzusetzen. Die SL treibt die Gruppe damit erzwungen zurück zum Ausgangspunkt (praktisch: der bestehende \"↺ Zurücksetzen\"-Knopf im 🧭-Bereich des Adminpanels bildet diesen Rückzug technisch ab).\n\nDamit endet die Erkundung dieser Insel bewusst vorzeitig — nicht jede Fundstelle muss oder soll in diesem Durchgang entdeckt werden. Zwei optionale Anknüpfungspunkte (SL-Ermessen, keine Pflicht): Die ungewöhnlichen Fußspuren, auf die die Gruppe möglicherweise unterwegs gestoßen ist (siehe Erkundungs-Graph, Ereignis \"Ungewöhnliche Fußspuren\"), könnten im Rückblick als frühe Vorwarnung gelesen werden. Und: wiederholte laute Fehlversuche beim Rätsel der Kiste (versteckte Grotte, Interaktion \"Das Rätsel der Kiste\") sind ein plausibler Grund, den 30-60-Minuten-Richtwert nach unten zu korrigieren — der Lärm hat die Ureinwohner schneller aufmerksam gemacht.",
        trigger: [
  ...
  "versteckte_grotte": {
    kurz: "Nur sichtbar nach erfolgreicher Wahrnehmungsprobe. Ein echtes Rätsel (Steinplatte + vier Tier-Steine) sichert die Kiste — deren Inhalt bleibt bewusst offen (Bibel 7.4: \"ein Vorteil, den die Spieler haben, ohne ihn zu kennen\").",
    interaktionen: {
      ...
      "das_raetsel_der_kiste": {
        ...
        kurz: "Eine Intelligenz-/Wissens-Probe übersetzt die Zeichen auf der Steinplatte zu einem Reim (Antwort: der Tiger). Von vier losen Tier-Steinen passt nur der gestreifte in die leere Fassung und öffnet die Kiste. Falscher Stein: lauter Knall, Weg bleibt zu, beliebig oft erneut versuchbar — SL-Ermessen: zu viele laute Fehlversuche können das Risiko erhöhen, die Eingeborenen früher auf die Gruppe aufmerksam zu machen.",
        details: "Die Zeichen auf der Steinplatte ergeben keinen Sinn auf den ersten Blick — erst eine erfolgreiche Intelligenz- oder Wissens-Probe setzt genug davon zusammen, um sie als Reim zu erkennen (SL-Ermessen, ob ein einzelner guter Erfolg reicht oder mehrere Spieler gemeinsam daran arbeiten müssen):\n\n„Ich habe Augen und sehe doch keinen Wald.\nMein Fell ist dick aus Gold und Schatten gewebt.\nIch laufe ohne Beine, und doch bin ich ans Gras gebunden.\nNenne meine Streifen, um das Tor zu passieren —\noder werde zur Beute des stillen Jägers.“\n\nDie Antwort ist der Tiger. Direkt neben der Steinplatte liegen vier lose, kunstvoll gearbeitete Steine, jeder mit dem Relief eines anderen Tieres — ein Fisch (Schuppenmuster), ein Vogel (Federmuster), eine Schlange (geringeltes Muster) und ein gestreiftes Raubtier. Eine leere, runde Fassung am Kistenmechanismus wartet darauf, dass einer der vier Steine hineingedrückt wird.\n\nDrücken die Spieler den gestreiften Stein (den Tiger) in die Fassung, klickt der Mechanismus, und die Kiste öffnet sich. Drücken sie einen der drei falschen Steine hinein, kracht es laut — der Mechanismus bleibt verschlossen, aber nichts geht kaputt, ein erneuter Versuch mit einem anderen Stein ist jederzeit möglich.\n\nSL-Ermessen: Der laute Knall bei einem Fehlversuch bleibt nicht zwangsläufig folgenlos — wiederholte laute Fehlversuche können das Risiko erhöhen, dass die Eingeborenen früher als sonst auf die Gruppe aufmerksam werden (siehe ORTE.riffstrand, Interaktion \"Die Eingeborenen greifen an\").",
        trigger: [
          { id: "zeichen_uebersetzt", label: "Erfolgreiche Intelligenz-/Wissens-Probe übersetzt die Zeichen zu einem Reim", info: "„Ich habe Augen und sehe doch keinen Wald. Mein Fell ist dick aus Gold und Schatten gewebt. Ich laufe ohne Beine, und doch bin ich ans Gras gebunden. Nenne meine Streifen, um das Tor zu passieren — oder werde zur Beute des stillen Jägers.“" },
          { id: "vier_steine_vorhanden", label: "Vier lose Steine mit Tier-Reliefs liegen bereit (Fisch/Vogel/Schlange/gestreiftes Raubtier)", info: "Eine leere, runde Fassung am Kistenmechanismus wartet darauf, dass einer der vier Steine hineingedrückt wird." },
          { id: "richtiger_stein_tiger", label: "Richtige Lösung: der gestreifte Stein (Tiger) öffnet die Kiste", info: "Ein Klicken, der Mechanismus öffnet sich." },
          { id: "falscher_stein_knall", label: "Falscher Stein → lauter Knall, Mechanismus bleibt verschlossen, erneut versuchbar", info: "Nichts geht kaputt, ein erneuter Versuch mit einem anderen Stein ist jederzeit möglich." },
          { id: "sl_ermessen_laerm_eingeborene", label: "SL-Ermessen: wiederholter Lärm kann die Eingeborenen früher aufmerksam machen", info: "Wiederholte laute Fehlversuche können das Risiko erhöhen, dass die Eingeborenen früher als sonst auf die Gruppe aufmerksam werden (siehe ORTE.riffstrand, \"Die Eingeborenen greifen an\")." }
        ]
      }
    }
  }
